    ...
    >
      <div className="absolute inset-0 bg-black/50 bg-opacity/50 flex items-center justify-center">
        <div className="text-center text-white max-w-3xl px-4">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mx-8 mb-6">
          ...
          <button className="bg-green-700 text-white text-xs sm:text-ms md:text-[16px]  py-3 px-8 rounded-lg  font-semibold hover:bg-green-700 transition duration-300">
